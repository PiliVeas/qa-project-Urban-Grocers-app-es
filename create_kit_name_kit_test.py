...
#Prueba 1. Número min permitido de caracteres (1):
def test_create_kit_1_letter_in_name_get_success_response():
    positive_assert(data.kit_body_name_t1)

#Prueba 2. Número max permitido de caracteres (511):
def test_create_kit_511_letter_in_name_get_success_response():
    positive_assert(data.kit_body_name_t2)

#Prueba 3. Número de caracteres menor que la cantidad permitida (0):
def test_create_kit_empty_name_get_error_response():
    negative_assert(data.kit_body_name_t3)

#Prueba 4. Número de caracteres mayor que la cantidad permitida (512):
...
#Prueba 8. Sin parámetro:
def test_create_kit_no_name_get_error_response():
    kit_body = data.kit_body.copy()
    kit_body.pop('name')
    negative_assert_no_name(kit_body)

#Prueba 9. Parámetro diferente (número):
